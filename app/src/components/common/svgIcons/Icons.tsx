...
import { ReactComponent as Role } from '@/assets/svg/role.svg';
import { ReactComponent as Candidate } from '@/assets/svg/candidate.svg';
...
export const CardIcon = (): JSX.Element => {
  return <Card />;
};
...
export const GraphIcon = (): JSX.Element => {
  return <Graph />;
};
...
export const CandidateIcon = (): JSX.Element => {
  return <Candidate />;
};
...
export const SelectArrowOpenIcon = (): JSX.Element => {
